            ...
            <div className='row'>
                ...
                <div className='col-6 mt-3 pt-3'>
                    <div className='text-center'>
                        <img src='/assets/nithinKamath.jpg' style={{width:'50%', height:'auto', borderRadius:'50%'}} alt='nithin-Kamath'></img><br/><br/>
                        <h5>Nithin Kamath</h5>
                        <p>Founder, CEO</p>
                    </div>
                </div>
                <div className='col-6 mt-3 pt-3'>
                    ...
                    <p className='pt-3'>Connect on <a href='https://nithinkamath.me/' style={{textDecoration:'none', color:"#387ed1"}}>Homepage</a> / <a href='https://tradingqna.com/u/nithin/summary' style={{textDecoration:'none', color:"#387ed1"}}>TradingQnA</a> / <a href='https://x.com/Nithin0dha' style={{textDecoration:'none', color:"#387ed1"}}>Twitter</a></p>
                </div>
            </div>
            <br/><br/><br/><br/>
            <div className='row mt-3 pt-3'>
                <div className='col-4 text-center'>
                    <img src='/assets/Nikhil.jpg' alt='Nikhil-Kamath' style={{width:'45%', height:'auto', borderRadius:'50%'}}></img>
                    <h5>Nikhil Kamath</h5>
                    <p>Co-founder & CFO</p>
                    <p><a href='#' style={{textDecoration:'none', color:'black'}}>Bio <i class="fa-solid fa-caret-down"></i></a></p>
                ...
                <div className='col-4 text-center'>
                    <img src='/assets/Kailash.jpg' alt='Nikhil-Kamath' style={{width:'45%', height:'auto', borderRadius:'50%'}}></img>
                    <h5>Dr. Kailash Nadh</h5>
                    <p>CTO</p>
                    <p>
                        <a href='#' style={{textDecoration:'none', color:'black'}}>Bio <i class="fa-solid fa-caret-down"></i></a>
                    </p>
                    <div>
                        <p>
                ...
                <div className='col-4 text-center'>
                    <img src='/assets/Venu.jpg' alt='Nikhil-Kamath' style={{width:'45%', height:'auto', borderRadius:'50%'}}></img>
                    <h5>Venu Madhav</h5>
                    <p>COO</p>
                    <p>
                        <a href='#' style={{textDecoration:'none', color:'black'}}>Bio <i class="fa-solid fa-caret-down"></i></a>
                ...
                {/* 2nd line*/}
                <div className='col-4 text-center'>
                    <img src='/assets/Hanan.jpg' alt='Hanan Delvi' style={{width:'45%', height:'auto', borderRadius:'50%'}}></img>
                    <h5>Hanan Delvi</h5>
                    <p>CCO</p>
                    <p>
                        <a href='#' style={{textDecoration:'none', color:'black'}}>Bio <i class="fa-solid fa-caret-down"></i></a>
                ...
                <div className='col-4 text-center'>
                    <img src='/assets/Seema.jpg' alt='Seema-Patil' style={{width:'45%', height:'auto', borderRadius:'50%'}}></img>
                    <h5>Seema Patil</h5>
                    <p>Director</p>
                    <p>
                        <a href='#' style={{textDecoration:'none', color:'black'}}>Bio <i class="fa-solid fa-caret-down"></i></a>
                ...
                <div className='col-4 text-center'>
                    <img src='/assets/karthik.jpg' alt='Karthik-Rangapa' style={{width:'45%', height:'auto', borderRadius:'50%'}}></img>
                ...
                {/*3rd Line*/}
                <div className='col-4 text-center'>
                    <img src='/assets/Austin.jpg' alt='Austin-Prakash' style={{width:'45%', height:'auto', borderRadius:'50%'}}></img>
